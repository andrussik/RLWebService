...
namespace Lucene.Net.Linq
{
    ...
    public abstract class QueryProvider : IQueryProvider
    {
        ...
        /// </summary>
        internal IQueryable Queryable { get; set; } = null!;
        ...
        private IQueryable Bind(Expression expression)
        {
            ...
            var binder = (LuceneQueryBinder)Activator.CreateInstance(
                binderType,
                FieldNameResolver)!;
        ...
        private object ExecuteQueryWorker(Expression expression)
        {
            ...
            var executor = (LuceneQueryExecutor)Activator.CreateInstance(executorType,
                Searcher,
                FieldNameResolver)!;
