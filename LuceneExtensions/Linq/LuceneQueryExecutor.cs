...
namespace Lucene.Net.Linq
{
    ...
    internal sealed class LuceneQueryExecutor<T> : LuceneQueryExecutor
    {
        ...
        public override object Execute(Expression expression)
        {
            ...
            var lambda = result as LambdaExpression;
            var genericLambda = result as Expression<Func<T>>;
        ...
        private Expression<TDelegate> GetExpressionForFilterableCall<TDelegate>(MethodCallExpression expression)
        {
            ...
            var queryable = (LuceneQueryable<T>)((ConstantExpression)expression.Arguments[0]).Value!;
            var method = typeof(LuceneQueryExecutor<T>).GetMethod(expression.Method.Name,
